<div class="content-wrapper">
  <div class="container-fluid">
	...
	<li>
		...
		<label for=lvtype class = "field-split align-left labelstyle" style="display:inline;margin-left:20px">
			Balance
		</label>

		<select name = "lvtype" style="width:325px;display:inline" 
                        class="field-style field-split align-left" id="lvtype" required>
...
<script>
	$(document).ready(function(){
		$("#lvtype").on('change',function(){
			var lvtype = $("#lvtype").val();
			$.get("<?php echo site_url('leave/leaveBal'); ?>",{leavetype:lvtype},function(data){
		...
		$("#days").on('change',function(){
			...
			if(days > lvno){
				...
				$("#days").css("border","1px solid #B0CFE0");
				$("#submit").show();
				return true;
			}
		});
